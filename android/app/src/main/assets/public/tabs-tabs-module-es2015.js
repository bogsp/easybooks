...
const routes = [
    {
        ...
        children: [
            {
                path: 'dashboard',
                loadChildren: () => Promise.all(/*! import() | dashboard-dashboard-module */[__webpack_require__.e("default~dashboard-dashboard-module~income-income-module~profile-profile-module"), __webpack_require__.e("dashboard-dashboard-module")]).then(__webpack_require__.bind(null, /*! ./dashboard/dashboard.module */ "./src/app/tabs/dashboard/dashboard.module.ts")).then(m => m.DashboardPageModule)
            },
            {
                path: 'profile',
                loadChildren: () => Promise.all(/*! import() | profile-profile-module */[__webpack_require__.e("default~dashboard-dashboard-module~income-income-module~profile-profile-module"), __webpack_require__.e("profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "./src/app/tabs/profile/profile.module.ts")).then(m => m.ProfilePageModule)
            },
            {
                path: 'income',
                loadChildren: () => Promise.all(/*! import() | income-income-module */[__webpack_require__.e("default~dashboard-dashboard-module~income-income-module~profile-profile-module"), __webpack_require__.e("income-income-module")]).then(__webpack_require__.bind(null, /*! ./income/income.module */ "./src/app/tabs/income/income.module.ts")).then(m => m.IncomePageModule)
            }
        ]
    }
];
...
TabsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    ...
    tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_store__WEBPACK_IMPORTED_MODULE_2__["AuthService"]])
], TabsPage);
